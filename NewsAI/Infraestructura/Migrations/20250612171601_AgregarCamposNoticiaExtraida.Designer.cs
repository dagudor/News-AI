...
namespace NewsAI.Migrations
{
    ...
    [Migration("20250612171601_AgregarCamposNoticiaExtraida")]
    partial class AgregarCamposNoticiaExtraida
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NewsAI.Dominio.Entidades.Configuracion", b =>
                {
                    ...
                    b.Property<string>("DiasPersonalizados")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("TEXT")
                    ...
                    b.Property<bool>("SchedulingActivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);
                    ...
                    b.HasIndex("SchedulingActivo");

                    b.HasIndex("UsuarioId");

                    b.HasIndex("UsuarioId1");

                    b.HasIndex("Activa", "SchedulingActivo", "ProximaEjecucion")
                        .HasDatabaseName("IX_Configuracion_SchedulingQuery");

                    b.HasIndex("UsuarioId", "Activa", "SchedulingActivo")
